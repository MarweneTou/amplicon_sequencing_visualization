...
def keep_more_than(tax_level, perc, df):
    ...
    try:
        mask = (df[fractions[0]] > perc) | (df[fractions[1]] > perc) | (df[fractions[2]] > perc) | (df[fractions[3]] > perc) | (df[fractions[4]] > perc) | (df[fractions[5]] > perc) | (df[fractions[6]] > perc) | (df[fractions[7]] > perc) | (df[fractions[8]] > perc) | (df[fractions[9]] > perc) | (df[fractions[10]] > perc) | (df[fractions[11]] > perc) | (df[fractions[12]] > perc) | (df[fractions[13]] > perc) | (df[fractions[14]] > perc) | (df[fractions[15]] > perc) | (df[fractions[16]] > perc) | (df[fractions[17]] > perc) | (df[fractions[18]] > perc) | (df[fractions[19]] > perc) | (df[fractions[20]] > perc) | (df[fractions[21]] > perc) | (df[fractions[22]] > perc) | (df[fractions[23]] > perc) | (df[fractions[24]] > perc)
    except: IndexError

    try:
        mask = (df[fractions[0]] > perc) | (df[fractions[1]] > perc) | (df[fractions[2]] > perc) | (df[fractions[3]] > perc) | (df[fractions[4]] > perc) | (df[fractions[5]] > perc) | (df[fractions[6]] > perc) | (df[fractions[7]] > perc) | (df[fractions[8]] > perc) | (df[fractions[9]] > perc) | (df[fractions[10]] > perc) | (df[fractions[11]] > perc) | (df[fractions[12]] > perc) | (df[fractions[13]] > perc) | (df[fractions[14]] > perc) | (df[fractions[15]] > perc) | (df[fractions[16]] > perc) | (df[fractions[17]] > perc) | (df[fractions[18]] > perc) | (df[fractions[19]] > perc) | (df[fractions[20]] > perc) | (df[fractions[21]] > perc) | (df[fractions[22]] > perc) | (df[fractions[23]] > perc)
    except: IndexError

    try:
        mask = (df[fractions[0]] > perc) | (df[fractions[1]] > perc) | (df[fractions[2]] > perc) | (df[fractions[3]] > perc) | (df[fractions[4]] > perc) | (df[fractions[5]] > perc) | (df[fractions[6]] > perc) | (df[fractions[7]] > perc) | (df[fractions[8]] > perc) | (df[fractions[9]] > perc) | (df[fractions[10]] > perc) | (df[fractions[11]] > perc) | (df[fractions[12]] > perc) | (df[fractions[13]] > perc) | (df[fractions[14]] > perc) | (df[fractions[15]] > perc) | (df[fractions[16]] > perc) | (df[fractions[17]] > perc) | (df[fractions[18]] > perc) | (df[fractions[19]] > perc) | (df[fractions[20]] > perc) | (df[fractions[21]] > perc) | (df[fractions[22]] > perc)
    except: IndexError


    try:
        mask = (df[fractions[0]] > perc) | (df[fractions[1]] > perc) | (df[fractions[2]] > perc) | (df[fractions[3]] > perc) | (df[fractions[4]] > perc) | (df[fractions[5]] > perc) | (df[fractions[6]] > perc) | (df[fractions[7]] > perc) | (df[fractions[8]] > perc) | (df[fractions[9]] > perc) | (df[fractions[10]] > perc) | (df[fractions[11]] > perc) | (df[fractions[12]] > perc) | (df[fractions[13]] > perc) | (df[fractions[14]] > perc) | (df[fractions[15]] > perc) | (df[fractions[16]] > perc) | (df[fractions[17]] > perc) | (df[fractions[18]] > perc) | (df[fractions[19]] > perc) | (df[fractions[20]] > perc) | (df[fractions[21]] > perc)
    except: IndexError
    ...
    try:
        mask = (df[fractions[0]] > perc) | (df[fractions[1]] > perc) | (df[fractions[2]] > perc) | (df[fractions[3]] > perc) | (df[fractions[4]] > perc) | (df[fractions[5]] > perc) | (df[fractions[6]] > perc) | (df[fractions[7]] > perc) | (df[fractions[8]] > perc) | (df[fractions[9]] > perc) | (df[fractions[10]] > perc) | (df[fractions[11]] > perc) | (df[fractions[12]] > perc) | (df[fractions[13]] > perc) | (df[fractions[14]] > perc) | (df[fractions[15]] > perc) | (df[fractions[16]] > perc) | (df[fractions[17]] > perc) | (df[fractions[18]] > perc) | (df[fractions[19]] > perc) | (df[fractions[20]] > perc)
    except: IndexError

    try:
        mask = (df[fractions[0]] > perc) | (df[fractions[1]] > perc) | (df[fractions[2]] > perc) | (df[fractions[3]] > perc) | (df[fractions[4]] > perc) | (df[fractions[5]] > perc) | (df[fractions[6]] > perc) | (df[fractions[7]] > perc) | (df[fractions[8]] > perc) | (df[fractions[9]] > perc) | (df[fractions[10]] > perc) | (df[fractions[11]] > perc) | (df[fractions[12]] > perc) | (df[fractions[13]] > perc) | (df[fractions[14]] > perc) | (df[fractions[15]] > perc) | (df[fractions[16]] > perc) | (df[fractions[17]] > perc) | (df[fractions[18]] > perc) | (df[fractions[19]] > perc)
    except: IndexError

    try:
        mask = (df[fractions[0]] > perc) | (df[fractions[1]] > perc) | (df[fractions[2]] > perc) | (df[fractions[3]] > perc) | (df[fractions[4]] > perc) | (df[fractions[5]] > perc) | (df[fractions[6]] > perc) | (df[fractions[7]] > perc) | (df[fractions[8]] > perc) | (df[fractions[9]] > perc) | (df[fractions[10]] > perc) | (df[fractions[11]] > perc) | (df[fractions[12]] > perc) | (df[fractions[13]] > perc) | (df[fractions[14]] > perc) | (df[fractions[15]] > perc) | (df[fractions[16]] > perc) | (df[fractions[17]] > perc) | (df[fractions[18]] > perc)
    except: IndexError

    try:
        mask = (df[fractions[0]] > perc) | (df[fractions[1]] > perc) | (df[fractions[2]] > perc) | (df[fractions[3]] > perc) | (df[fractions[4]] > perc) | (df[fractions[5]] > perc) | (df[fractions[6]] > perc) | (df[fractions[7]] > perc) | (df[fractions[8]] > perc) | (df[fractions[9]] > perc) | (df[fractions[10]] > perc) | (df[fractions[11]] > perc) | (df[fractions[12]] > perc) | (df[fractions[13]] > perc) | (df[fractions[14]] > perc) | (df[fractions[15]] > perc) | (df[fractions[16]] > perc) | (df[fractions[17]] > perc)
    except: IndexError
    ...
    try:
        mask = (df[fractions[0]] > perc) | (df[fractions[1]] > perc) | (df[fractions[2]] > perc) | (df[fractions[3]] > perc) | (df[fractions[4]] > perc) | (df[fractions[5]] > perc) | (df[fractions[6]] > perc) | (df[fractions[7]] > perc) | (df[fractions[8]] > perc) | (df[fractions[9]] > perc) | (df[fractions[10]] > perc) | (df[fractions[11]] > perc) | (df[fractions[12]] > perc) | (df[fractions[13]] > perc) | (df[fractions[14]] > perc) | (df[fractions[15]] > perc)
    except: IndexError

    try:
        mask = (df[fractions[0]] > perc) | (df[fractions[1]] > perc) | (df[fractions[2]] > perc) | (df[fractions[3]] > perc) | (df[fractions[4]] > perc) | (df[fractions[5]] > perc) | (df[fractions[6]] > perc) | (df[fractions[7]] > perc) | (df[fractions[8]] > perc) | (df[fractions[9]] > perc) | (df[fractions[10]] > perc) | (df[fractions[11]] > perc) | (df[fractions[12]] > perc) | (df[fractions[13]] > perc) | (df[fractions[14]] > perc)
    except: IndexError

    try:
        mask = (df[fractions[0]] > perc) | (df[fractions[1]] > perc) | (df[fractions[2]] > perc) | (df[fractions[3]] > perc) | (df[fractions[4]] > perc) | (df[fractions[5]] > perc) | (df[fractions[6]] > perc) | (df[fractions[7]] > perc) | (df[fractions[8]] > perc) | (df[fractions[9]] > perc) | (df[fractions[10]] > perc) | (df[fractions[11]] > perc) | (df[fractions[12]] > perc) | (df[fractions[13]] > perc)
    except: IndexError

    try:
        mask = (df[fractions[0]] > perc) | (df[fractions[1]] > perc) | (df[fractions[2]] > perc) | (df[fractions[3]] > perc) | (df[fractions[4]] > perc) | (df[fractions[5]] > perc) | (df[fractions[6]] > perc) | (df[fractions[7]] > perc) | (df[fractions[8]] > perc) | (df[fractions[9]] > perc) | (df[fractions[10]] > perc) | (df[fractions[11]] > perc) | (df[fractions[12]] > perc)
    except: IndexError
...
def info(df, combo):
    ...
    return ("This field contains explanations about the results:  \nAbout this file:\nThe samples number is {}\n Number of distinct taxa above the treshhold is {}".format(len(sampl_names), dist_otus))
